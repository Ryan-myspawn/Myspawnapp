...
## Queue (next up)
1. **2026-09-13 · lane (c):** "How to Record a Family Health History (and Why Doctors Want It More Than a DNA Test)" — slug `family-health-history-guide`, primary "how to record family health history" (legacy lane; the free action we keep recommending across articles and have never written up).
