...
| 2026-08-30 | "Priced at Birth" | Cord-blood banking economics (CBR/Cryo-Cell/Cells4Life verified prices, one-moment sales channel, honest steelman, ambient-keratin economics close). USED. |
...
| 2026-09-19 | "Nobody Did Anything Wrong" | Digital-legacy category failure rate as a BASE RATE, not an anecdote: HereAfter's wind-down (homepage dark, iOS app last updated Sep 2023, support email the only retrieval route, no self-serve export) plus StoryFile Chapter 11 May 2024, Eternos leaving the category Nov 2025, You Only Virtual on a waitlist Jul 2026. **The central source is a direct competitor of the company described, and the episode discloses that ON AIR.** Segment 3 turns the base rate on MySpawn and states that our own continuity document does not exist. Founder-gated line with verbatim fallback. USED. |

## YouTube explainers
| Date | Title | Core material |
|---|---|---|
| 2026-09-19 | "How to Read a Supplement Study in Four Minutes" | Evidence-grading METHOD taught through plasmalogens as the worked example (when published / how many people / primary endpoint met / is every paper still standing). Facts: 2022 mouse paper recirculating as Sep 2026 news; Fujino *eBioMedicine* 2017, 328 patients, 1 mg/day, 24 weeks, NULL on primary and on all secondaries in ITT; *Front Nutr* 2026, 68 adults, 1 mg/day, 12 weeks, positive on verbal memory; a human plasmalogen study retracted in 2026 after a January Expression of Concern. Distinct from the 17 Sep autophagy explainer's supplement section because the subject is the method, not a compound. USED. |
...
| 2026-08-30 | "Hair vs Saliva vs Blood: What Actually Survives" | Sample-type stability explainer (24h saliva problem, keratin flip, 2026 Genome Biology rootless-hair peg); same-day cascade from the blog article. USED. |
...
| 2026-08-30 | "The Name Test" | Family-photo identification quiz (dad names faces on camera; record-the-naming Vault fix; score UGC loop) |
...
- 2026-09-19: **digital-legacy base-rate episode (NEW angle: four companies in two years, and the turn is on us)** · **supplement-evidence METHOD explainer (NEW: teaches grading, uses plasmalogens as the worked example)** · **"Backwards From Five" reverse-argument evergreen (NEW format)** · Daily Review proposes a recurring methods slot and holds the 233-clocks piece to the week of 22 September.
