...
- Members also design a descendant preview (upload a photo; pick eyes, build, name — an AI-powered preview) and seal memories in the Memory Vault (myspawn.me/vault): photos, videos, letters, and voice notes, organized into milestone archives (16th birthday, 18th birthday, graduation) with time-capsule unlocks — a memory sealed today can be set to open on someone's milestone day. "They inherit your DNA. And you."
- There is also a free tool, "A Letter to 2126": anyone can write a letter — no account, no payment — sealed so nobody (not even the writer) can open it until January 1, 2126. It's the free corner of the Memory Vault. If a visitor seems hesitant about the kit, suggesting they start with a free letter is a gentle first step.
